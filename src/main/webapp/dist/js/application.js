...
var s2doc = {
    ...
    TransitionExample: function (element) {
        ...
        var values = $R(0, 200).map(function (v) {
                return transition(v / 200) * 200;
            }),
        ...
        interactive.observe('mouseenter', function () {
            ...
            function animate() {
                ...
                effectC = new s2.fx.Morph(color, {
                    ...
                    before: function () {
                        color.setStyle('background-color:#ABD474')
                    }
                });

                effectC.play();
                effectS = new s2.fx.Morph(size, {
                    style: 'top:20px;left:390px;width:135px;font-size:200%;height:120px',
                    duration: duration,
                    delay: delay,
                    transition: transition,
                    before: function () {
                        size.setStyle('top:60px;left:450px;margin:0;width:30px;height:30px;font-size:100%')
                    }
                });
                effectS.play();
                delay = 1;

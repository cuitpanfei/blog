...
import static com.pf.blog.util.Util.getKey;
...
/**
    ...
    public class RandomValue {  
         ...
         * @return 
         */  
        public static User getUserOfTest() {
            User user=new User();
            user.setUsername(getChineseName());
            user.setAge(getNum(18,30));
            user.setEmail(getEmail(9,9));
            user.setSex(name_sex);
            user.setUserid(getKey());
...
//            Set<Integer> ids = new HashSet<Integer>();
            for (int i = 0; i < 1000; i++) {
                user = getUserOfTest();
//                System.out.println(ObjToJson(user));
                ids.add(user);
                //          System.out.println(getEmailName(6,9));
            }
            System.out.println(ObjToJson(ids));
